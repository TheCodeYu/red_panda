    ...
    >
      ...
      <div class="box-center">
        ...
        <div class="box-center-center loader" @mousedown.stop="showThisApp">
          ...
          >
            <div class="controll">
              <div class="close" @click.stop="closeApp" title="关闭">
              </div>
              <div class="min" @click.stop="hideApp" title="最小化"></div>
              <div
                class="full"
...
export default defineComponent({
  ...
  methods: {
     ...
     */
    appEvent(e: { event: any; data: any; app: any; pid: any; title: any }) {
      switch (e.event) {
        case 'windowMaxSize':
    ...
    getExtBoxClasses() {
      ...
      if (
        this.openAppList[this.openAppList.length - 1]
          .pid === this.app.pid
      ) {
        str += 'isTop '
      }
     ...
     * @description: 鼠标按下
     */
    positionMouseDown(e: { clientX: number; clientY: number }) {
    ...
    mouseMove(e: { clientY: number; clientX: number }) {
